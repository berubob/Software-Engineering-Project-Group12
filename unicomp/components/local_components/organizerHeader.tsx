      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between">
          ...
          <nav className="hidden md:flex gap-10 text-[#1e40af] text-[15px] font-bold">
            ...
            <Link href="/dashboard/published" className="hover:text-white transition-colors">
              Published
            </Link>
            <Link href="/dashboard/pending-approval" className="hover:text-white transition-colors">
              Pending Approval
            </Link>
            <Link href="/dashboard/draft" className="hover:text-white transition-colors">
              Draft
            </Link>
          </nav>
